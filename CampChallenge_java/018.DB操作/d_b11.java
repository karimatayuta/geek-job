...
public class d_b11 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                db_st = db_con.prepareStatement("Update tab set name = ?,tel = ?,age = ?,birthday = ? where profilesID = ?");//条件によるレコードの削除
                db_st.setString(1, "サザエさん");
                db_st.setString(2, "090-1234-1234");
                db_st.setInt(3,30);
                db_st.setString(4,"1999-12-31");
                db_st.setInt(5, id1);
